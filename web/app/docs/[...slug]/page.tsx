...
export default async function DocumentPage({ params }: Props) {
  ...
  }}>{doc.body}</ReactMarkdown></article><div className="document-end"><Link className="text-link" href={`/library?section=${encodeURIComponent(doc.section)}`}>More in {doc.section} <span aria-hidden="true">↗</span></Link></div></div>;
}
