...
5. Use the canonical instructions in [`TLC-OS/PROCESS-DOCUMENTATION-GUIDE.md`](TLC-OS/PROCESS-DOCUMENTATION-GUIDE.md) and the relevant skill under [`everything-is-computer/skills`](everything-is-computer/skills/).
...
Read [`everything-is-computer/AGENTS.md`](everything-is-computer/AGENTS.md) before making repository changes. It defines scope, document handling, privacy, and validation expectations. Keep canonical documents and skills in their designated locations rather than creating parallel copies.
