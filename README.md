...
The website is a static Next.js application in [`Everything is computer/web`](Everything%20is%20computer/web/). It reads Markdown at build time and publishes only documents under these explicit source directories:
